...
#ifndef INCLUDED_PDU_SOCKET_PDU_H
#define INCLUDED_PDU_SOCKET_PDU_H
 ...
 */
class PDU_API socket_pdu : virtual public block
{
public:
    // gr::pdu::socket_pdu::sptr
...
#endif /* INCLUDED_PDU_SOCKET_PDU_H */
