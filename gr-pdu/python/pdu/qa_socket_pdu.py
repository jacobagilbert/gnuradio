...
class qa_socket_pdu (gr_unittest.TestCase):
    ...
    def test_001(self):
        ...
        self.pdu_send = pdu.socket_pdu("UDP_CLIENT", "localhost", port)
        self.pdu_recv = pdu.socket_pdu("UDP_SERVER", "localhost", port)
        self.pdu_send = None
        self.pdu_recv = None
    ...
    def test_004(self):
        ...
        self.pdu_source = blocks.message_strobe(pdu_msg, 500)
        self.pdu_send = pdu.socket_pdu("TCP_SERVER", "localhost", port, mtu)
        self.pdu_recv = pdu.socket_pdu("TCP_CLIENT", "localhost", port, mtu)
