...
class test_pdu(gr_unittest.TestCase):
    ...
    def test_000(self):
        ...
        src = pdu.pdu_to_tagged_stream(pdu.types.byte_t)
        snk3 = pdu.tagged_stream_to_pdu(pdu.types.byte_t)
    ...
    def test_001(self):
        ...
        src = pdu.pdu_to_tagged_stream(pdu.types.float_t)
    ...
    def test_002_tags_plus_data(self):
        ...
        ts2pdu = pdu.tagged_stream_to_pdu(pdu.types.float_t, "packet_len")
        dbg = blocks.message_debug()
